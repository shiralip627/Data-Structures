...
names [1] # In R, indexing starts at 1, not 0 like Python.
```
...
```{r}
my_vector <- c(10, 19, 4, -2, -6, 0, 1200)
sort(my_vector)
```
...
matrix_1 <- matrix(first_vector, nrow = 3, ncol = 3, byrow = TRUE)
matrix_2 <- matrix(second_vector, nrow = 3, ncol = 3, byrow = TRUE)

array_of_matrices <- array(c(matrix_1, matrix_2), dim = c(3, 3, 2), dimnames = list(c("ROW 1", "ROW 2", "ROW 3"), c("COL 1", "COL 2", "COL 3"), c("MATRIX 1", "MATRIX 2")))
